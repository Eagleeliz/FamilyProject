...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <nav className="bg-gray-900 border-b border-gray-800 px-4 py-4 lg:px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4 lg:gap-8">
            ...
            <div className={`${mobileMenuOpen ? 'flex' : 'hidden'} lg:flex absolute lg:relative top-full lg:top-0 left-0 lg:left-auto flex-col lg:flex-row items-start lg:items-center gap-3 lg:gap-6 bg-gray-900 lg:bg-transparent p-4 lg:p-0 border-b lg:border-b-0 border-gray-800 w-full lg:w-auto`}>
